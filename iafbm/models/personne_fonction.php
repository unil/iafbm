...
class PersonneFonctionModel extends iaModelMysql {
    ...
    var $mapping = array(
        ...
        'fonction_hospitaliere_id' => 'fonction_hospitaliere_id',
    ...
    var $joins = array(
        ...
        'titre_academique' => 'LEFT JOIN titres_academiques ON (personnes_fonctions.titre_academique_id = titres_academiques.id)',
        'fonction_hospitaliere' => 'LEFT JOIN fonctions_hospitalieres ON (personnes_fonctions.fonction_hospitaliere_id = fonctions_hospitalieres.id)',
        'departement' => 'LEFT JOIN departements ON (personnes_fonctions.departement_id = departements.id)'
    );

    var $join = array('personne', 'titre_academique', 'fonction_hospitaliere', 'departement');
}
